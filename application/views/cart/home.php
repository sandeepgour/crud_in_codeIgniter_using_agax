        ...
        <div class="col-md-3 col-sm-6" style="float: left;">
            <div class="product-grid2">
                <div class="product-image2">
                    <a href="#">
                        <img class="pic-1" src="<?php echo base_url(); ?>uploads/<?php echo $value['image']; ?>">
                        <img class="pic-2" src="<?php echo base_url(); ?>uploads/<?php echo $value['image']; ?>">
                    </a>
                  <!--   <ul class="social">
                    ...
                    <a class="add-to-cart" href="<?php echo base_url('Cart_Controller/add_to_cart/'); echo $value['id']; ?>">Add to cart</a>
                </div>
                <div class="product-content">
                <h3 class="title"><a href="#"><?php echo $value['name']; ?></a></h3>
                    <span class="price"><span style="color:red;">Price:</span><?php echo $value['price']; ?></span>
                </div>
            </div>
        </div>
    <?php } ?>
...
<div class="container">
    <div class="row">
        <div class="col-sm-12">
            <a href="<?php echo base_url('Cart_Controller/Add_product'); ?>" class="btn btn-success">Add Product</a>
        </div>
    </div>
</div>
